<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.sql.*, java.text.SimpleDateFormat, java.util.Date, java.util.Set, 
                 java.util.HashSet, main.java.Demo, java.util.List, java.util.ArrayList, 
                 java.util.Collections, java.util.Comparator, java.text.ParseException" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<%    
    ...
    getServletContext().log(selectedDate);
    getServletContext().log("Selected time is: " + selectedTime);
    getServletContext().log("Selected court is: " + selectedCourt);
...
<%
    ...
    try {
        ...
        if (selectedDate != null && !selectedDate.isEmpty()) {
            ...
            getServletContext().log(date);

            String query = "SELECT * FROM courts WHERE day = ? AND availability = 'yes'";
            ...
            if(rs.next()) {
                ...
                for (String time : Times) {
                    ...
                    String insertQuery1 = "insert into courts(day,play,availability,court) values (?,?,'yes','Court 1')";
                    pstmt = conn.prepareStatement(insertQuery1);
                    pstmt.setString(1, date);
                    pstmt.setString(2, time);
                    pstmt.executeUpdate(); 
                    
                    String insertQuery2 = "insert into courts(day,play,availability,court) values (?,?,'yes','Court 2')";
            ...
            getServletContext().log("Selected date is empty");
        }
    } catch (Exception e) {
        ...
        <div class="start">
            ...
            <select class="hrs" name="times" id="times" onchange="selectTime()">
                <% if (!availableTimes.isEmpty()) { 
                    ...
                    List<String> sortedTimes = new ArrayList<>(availableTimes);
